<template>
  ...
  <div>
    ...
    <div class="panel panel-profile">
      <div class="clearfix">
        <!-- LEFT COLUMN -->
        <div class="profile-left" style="height:500px;">
        ...
        <div class="profile-right">
          ...
          <div class="custom-tabs-line tabs-line-bottom left-aligned">
            <ul class="nav" role="tablist">
              ...
              <li><a href="#tab-bottom-left3" role="tab" data-toggle="tab" v-if="supports">Supports</a></li>
            </ul>
          </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                <select class="form-control" v-model="assign.company_id" required>
                                    ...
                                    <option v-for="(company, index) in companies" :value="company._id">{{ company.name }}</option>
                                </select>
                            </div>
                            <div class="form-group">
                               <select class="form-control" v-model="assign.rider_id" required>
                                    <option value="">-- Select Rider --</option>
                                    <option v-for="(rider, index) in riders" :value="rider._id">{{ rider.first_name +' '+ rider.last_name }}</option>
                                </select>
                            </div>
